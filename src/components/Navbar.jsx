    ...
    <nav className="w-full bg-black text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="w-full flex justify-center">
          <div className="w-full max-w-md">
            <div className="flex items-center border border-red-800 rounded-full overflow-hidden bg-black">
              ...
              <input type="text" placeholder="Search for wheels..."
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-semibold">
          ...
          <Link to="/orders" className="flex items-center gap-1 hover:underline"><IoReorderFour /> Orders</Link>
          {userName ? (
          ...
          {userName ? (
            <>
              ...
              <button
                ...
                className="text-sm border border-red-600 text-red-500 px-3 py-1 rounded hover:bg-red-600 hover:text-white"
              >
                Logout
              </button>
            </>
